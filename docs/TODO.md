...
- [ ] `git init` and first commit (the README + licenses)
- [ ] Create `github.com/SHA888/mais-log` repo (public)
- [ ] Push initial commit
- [ ] Verify repo is visible and licenses are detected by GitHub
...
- [ ] Install Zola locally; verify `zola build` succeeds
- [ ] Verify `zola serve` renders the site as expected
- [ ] Iterate on stylesheet until reading the site is comfortable
...
- [ ] Acquire Anderson, *Security Engineering* (3rd ed., free online)
...
- [ ] Read WHO *Ethics & Governance of AI for Health* (2021)
- [ ] Read James Reason, *Human Error* OR *Managing the Risks of
  Organizational Accidents* (one, not both)
  - [ ] Decide which
  - [ ] Read
...
- [ ] Complete Anderson, *Security Engineering*
- [ ] Move to threat modeling depth: Shostack, *Threat Modeling*
...
- [ ] Academic publication: 1+ paper per year in venues like *Nature
  Digital Medicine*, *JAMIA*, *npj Digital Medicine*, USENIX Security,
...
*(None yet. When this TODO's scope changes meaningfully, append a revision
